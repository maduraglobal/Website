...
export default function DynamicVisaDetailPage({ params }: { params: Promise<{ region: string, slug: string }> }) {
  ...
  return (
    <div className="font-sans min-h-screen bg-[#f8f9fa] text-[#333] text-[14px] leading-relaxed pt-16">
      ...
      {/* ===== STICKY NAV BAR ===== */}
      <div className="sticky top-16 z-40 bg-[#191974] text-white shadow-xl w-full border-b border-white/10 overflow-x-auto no-scrollbar">
