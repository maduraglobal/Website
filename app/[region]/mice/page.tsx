    ...
    <div className="bg-[var(--background)] min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16 -mt-10 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: "📊", title: "Meetings", desc: "Board meetings, team offsites, and retreats at world-class venues.", color: "from-[#191974] to-[#00a1e5]" },
            { icon: "🏆", title: "Incentives", desc: "Reward top performers with unforgettable international incentive trips.", color: "from-[#ee2229] to-[#f4a021]" },
            { icon: "🎤", title: "Conferences", desc: "End-to-end conference management — venue, logistics, AV, hospitality.", color: "from-[#82c341] to-[#00a1e5]" },
            { icon: "🎪", title: "Exhibitions", desc: "Trade show and international expo representation services.", color: "from-[#f4a021] to-[#ee2229]" }
          ].map((s, i) => (
      ...
      <section className="py-16 bg-gray-50 border-y border-gray-100">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-[36px] font-bold font-inter text-[#191974] mb-4 text-center">Why Madura for Corporate Travel?</h2>
          <p className="text-[16px] text-gray-500 font-inter-tight text-center mb-12">Trusted by 500+ corporates across India.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: "Dedicated Account Manager", desc: "A single point of contact for planning and on-ground support.", icon: "👤" },
              { title: "Global Venue Network", desc: "1000+ pre-vetted venues and resorts across 60+ countries.", icon: "🌐" },
              { title: "End-to-End Management", desc: "Travel logistics, accommodation, event production — we handle it all.", icon: "✅" }
            ].map((f, i) => (
              <div key={i} className="bg-white border border-gray-200 p-8 rounded-2xl hover:shadow-lg transition-shadow text-center">
                ...
                <h3 className="text-[18px] font-bold text-[#171717] mb-3 font-inter">{f.title}</h3>
                <p className="text-[14px] text-gray-600 font-inter-tight leading-relaxed">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          {!submitted ? (
            <>
              <div className="text-center mb-10">
                <h2 className="text-[28px] font-bold font-inter text-[#171717] mb-2">Request a MICE Proposal</h2>
                <p className="text-[14px] text-gray-500 font-inter-tight">Our team will respond within 24 hours.</p>
              </div>
            ...
            <div className="flex flex-col items-center text-center py-10">
              ...
              <h3 className="font-bold text-[24px] text-[#171717] mb-2 font-inter">Enquiry Submitted!</h3>
              <p className="text-[15px] text-gray-600 mb-8 font-inter-tight">We&apos;ll send a proposal to {formData.email} within 24 hours.</p>
