        ...
        <div className="max-w-6xl mx-auto w-full px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center border border-gray-200 rounded-2xl md:rounded-full bg-white shadow-2xl py-2 px-3 transition-shadow hover:shadow-[0_25px_60px_rgba(0,0,0,0.15)]">
            ...
            <div className="w-full lg:w-auto p-1 flex h-full">
              <button
                suppressHydrationWarning
                className="w-full lg:w-[120px] bg-[#ee2229] hover:bg-[#d11920] text-white font-black py-3 px-6 rounded-full transition-all shadow-md active:scale-95 text-[13px] tracking-widest flex items-center justify-center gap-2"
              >
                <span>Search</span>
              </button>
            </div>
      ...
      <section className="py-12 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-8">
            ...
            <p className="font-inter text-[16px] text-black font-light">Discover the world&apos;s most sought-after holiday spots.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
            <div>
              ...
              <p className="font-inter text-[16px] text-black ">Explore some of our most popular tours selected for you.</p>
            </div>
          </div>
          ...
          <div className="relative w-full h-[400px] lg:h-[450px] rounded-[24px] overflow-hidden group shadow-2xl">
            ...
            <div className="relative h-full flex flex-col justify-center px-10 lg:px-20 text-white max-w-2xl">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <p className="text-xs font-black tracking-[0.3em] uppercae opacity-70 mb-1">Featured Offer</p>
              ...
              <button
                suppressHydrationWarning
                className="book-now-btn bg-[#ee2229] border border-[#ee2229] hover:bg-transparent text-white px-10 py-3.5 rounded-lg font-black text-xs uppercase tracking-[0.2em] transition-all transform active:scale-95 shadow-xl shadow-red-500/30"
