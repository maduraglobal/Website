    ...
    <div className="bg-white min-h-screen text-[#191974] font-arial text-[14px]">
      ...
      <div className="bg-white border-b border-gray-50">
        <div className="max-w-7xl mx-auto px-4 py-10">
          <div className="flex items-center gap-2 text-[11px] text-gray-300 font-black mb-6  tracking-widest">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div className="flex-1">
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="text-[10px] font-black tracking-widest  bg-[#ee2229] text-white px-3 py-1.5 rounded-sm shadow-lg shadow-red-500/20">
                  Best Seller
                </span>
                {(currentTour.tags || ["Family", "Premium", "Group Tour"]).map((tag: string) => (
                  <span key={tag} className="text-[10px] font-black tracking-widest  bg-[#191974]/5 text-[#191974] px-3 py-1.5 rounded-sm border border-[#191974]/10">
                    {tag}
                  </span>
                ))}
              </div>
              ...
              <div className="flex items-center gap-8 mt-4">
                <span className="text-[14px] font-black text-[#ee2229]  tracking-widest flex items-center gap-2 font-inter-tight">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[11px] font-black text-gray-300 ml-2 tracking-widest ">(4.9 Rated)</span>
                </div>
              </div>
            </div>
            <div className="hidden md:flex flex-col items-end gap-1">
              <span className="text-[11px] font-black text-gray-300  tracking-widest">Share this Tour</span>
      ...
      <div className="w-full h-[50vh] min-h-[450px] relative overflow-hidden">
        ...
        <div className="absolute bottom-10 left-0 right-0">
          <div className="max-w-7xl mx-auto px-4">
            <button className="bg-white/10 backdrop-blur-xl hover:bg-white/20 text-white border border-white/20 px-8 py-3 rounded-xl text-[12px] font-black transition-all  tracking-[0.2em] shadow-2xl">
