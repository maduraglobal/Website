  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'details':
        return (
          <div className="space-y-12 animate-in fade-in duration-700">
            <h2 className="text-[26px] font-inter font-light text-[#191974] tracking-tight border-b border-gray-100 pb-6 ">Accommodation Details</h2>
            <AccommodationTable />
          </div>
        );
      case 'info':
        return (
          <div className="space-y-12 animate-in fade-in duration-700">
            <section>
              <h2 className="text-[26px] font-inter font-light text-[#191974] tracking-tight mb-8 border-b border-gray-100 pb-6 ">Inclusions & Exclusions</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="bg-white border border-[#191974]/10 p-8 rounded-2xl shadow-sm">
                  <h3 className="text-[12px] font-black text-[#191974] mb-6 flex items-center gap-2  tracking-widest">
                ...
                <div className="bg-white border border-[#ee2229]/10 p-8 rounded-2xl shadow-sm">
                  <h3 className="text-[12px] font-black text-[#ee2229] mb-6 flex items-center gap-2  tracking-widest">
      ...
      case 'needtoknow':
        return (
          <div className="space-y-12 animate-in fade-in duration-700">
            <h2 className="text-[26px] font-inter font-light text-[#191974] tracking-tight mb-8 border-b border-gray-100 pb-6 ">Need to Know</h2>
      ...
      case 'policy':
        return (
          <div className="space-y-12 animate-in fade-in duration-700">
            <h2 className="text-[26px] font-inter font-light text-[#191974] tracking-tight mb-8 border-b border-gray-100 pb-6 ">Cancellation Policy</h2>
            <div className="overflow-hidden border border-gray-100 rounded-2xl shadow-sm">
              <table className="w-full text-left font-arial">
                <thead className="bg-[#191974] text-white">
                  <tr>
                    <th className="px-8 py-5 text-[11px] font-black  tracking-[0.2em] opacity-80">Timeline</th>
                    <th className="px-8 py-5 text-[11px] font-black  tracking-[0.2em] opacity-80 text-right">Penalty Charges</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-50">
                  <tr>
                    <td className="px-8 py-5 text-[14px] text-gray-500 font-bold ">More than 45 Days</td>
                    <td className="px-8 py-5 text-[14px] font-black text-[#191974] text-right">Non-refundable Deposit</td>
                  </tr>
                  <tr>
                    <td className="px-8 py-5 text-[14px] text-gray-500 font-bold ">30 - 45 Days</td>
                    <td className="px-8 py-5 text-[14px] font-black text-[#191974] text-right">50% of Tour Cost</td>
                  </tr>
                  <tr>
                    <td className="px-8 py-5 text-[14px] text-gray-500 font-bold ">Less than 30 Days</td>
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-2/3">
            ...
            <div className="mt-20 bg-gray-50 rounded-3xl p-12 border border-gray-100 relative overflow-hidden">
              ...
              <h3 className="text-[26px] font-inter font-light text-[#191974] mb-12 text-center  tracking-tight">The Madura Standard</h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10 relative z-10">
                {[
                  ...
                  <div key={i} className="text-center group">
                    ...
                    <h4 className="text-[12px] font-black text-[#191974] mb-3  tracking-widest">{item.title}</h4>
                    <p className="text-[13px] text-gray-400 leading-relaxed font-arial font-bold  tracking-tighter opacity-60">{item.desc}</p>
                  </div>
                ))}
              </div>
            </div>
