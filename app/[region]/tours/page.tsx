  ...
  return (
    <div className="bg-white min-h-screen font-arial text-[14px]">
      ...
      <div className="w-full bg-[#191974] py-16 text-center text-white">
        <h1 className="text-[32px] font-black font-inter mb-4  tracking-tight">All Holiday Packages</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row gap-8">
        ...
        <aside className="w-full md:w-1/4 shrink-0 flex flex-col gap-6">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
            <h3 className="font-bold text-[#191974] text-[16px] border-b border-gray-100 pb-3 mb-4  font-inter tracking-wider">Destination</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
            <h3 className="font-bold text-[#191974] text-[16px] border-b border-gray-100 pb-3 mb-4  font-inter tracking-wider">Duration</h3>
            <div className="flex flex-col gap-3 font-arial text-[14px]">
            ...
            {displayTours.map((tour) => (
              <div key={tour.id} className="bg-white border border-gray-200 rounded-[12px] overflow-hidden shadow-sm flex flex-col group transition-all hover:shadow-xl">
                ...
                <div className="p-5 flex flex-col flex-1">
                  <p className="text-[11px] text-[#ee2229] font-black  tracking-widest mb-1 font-inter-tight">Explorer</p>
                  <Link href={`/${region}/tours/${tour.slug}`}>
                    <h3 className="text-[17px] font-bold text-[#191974] mb-4 leading-snug line-clamp-2 h-[48px] hover:text-[#ee2229] transition-colors font-inter">{tour.title}</h3>
                  </Link>

                  <div className="flex items-center justify-between mb-6 pt-4 border-t border-gray-100">
                    <div className="flex flex-col">
                      <p className="text-[10px] text-gray-400 font-bold  tracking-widest">Starts from</p>
                    ...
                    <button
                      type="button"
                      className="book-now-btn bg-[#ee2229] text-white px-5 py-2.5 rounded-lg text-[13px] font-bold font-inter-tight hover:bg-[#191974] transition-all  tracking-widest shadow-md"
                  ...
                  <div className="flex items-center justify-between py-3 border-t border-gray-50 mt-auto">
                    <span className="text-[11px] font-bold text-gray-400  tracking-widest">Included</span>
