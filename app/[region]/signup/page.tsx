      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-lg">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-[12px] text-gray-400 font-bold uppercase tracking-widest">or sign up with email</span>
            <div className="flex-1 h-px bg-gray-200"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-1.5">
                <label className="text-[12px] font-bold text-gray-600 tracking-wide uppercase px-1">First Name</label>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-[12px] font-bold text-gray-600 tracking-wide uppercase px-1">Last Name</label>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[12px] font-bold text-gray-600 tracking-wide uppercase px-1">Email Address</label>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[12px] font-bold text-gray-600 tracking-wide uppercase px-1">Phone Number</label>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[12px] font-bold text-gray-600 tracking-wide uppercase px-1">Password</label>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="text-[12px] font-bold text-gray-600 tracking-wide uppercase px-1">Confirm Password</label>
