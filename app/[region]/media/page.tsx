    ...
    <div className="min-h-screen bg-white font-inter">
      ...
      <section className="pt-40 pb-20 bg-gray-50 border-b border-gray-100 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            <div className="flex items-center gap-2 text-[#ee2229] font-black  tracking-[0.3em] mb-4 text-[12px]">
              <Newspaper className="w-5 h-5" />
              Press & Insights
            </div>
            <h1 className="text-[48px] md:text-[72px] font-black text-[#191974]  tracking-tighter leading-none mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="lg:w-2/5 p-12 md:p-16 flex flex-col justify-center bg-[#191974] text-white">
              <div className="flex items-center gap-4 text-[#ee2229] text-[12px] font-black  tracking-widest mb-6">
                <span>Featured Article</span>
                <span className="w-10 h-px bg-[#ee2229]" />
                <span>June 2024</span>
              </div>
              <h2 className="text-[32px] md:text-[42px] font-black leading-tight mb-6  tracking-tight">
              ...
              <button className="self-start flex items-center gap-2 text-white font-black  tracking-widest group">
                Read Full Story
            ...
            {news.map((item, i) => (
              ...
              >
                <div className="relative aspect-video rounded-3xl overflow-hidden mb-6 shadow-xl">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm px-4 py-1.5 rounded-full text-[11px] font-black text-[#191974]  tracking-widest flex items-center gap-1.5 shadow-lg">
                ...
                <div className="mt-auto pt-6 border-t border-gray-100 flex items-center justify-between">
                  <button className="flex items-center gap-2 text-[12px] font-black text-[#191974]  tracking-widest group/btn transition-colors hover:text-[#ee2229]">
                    Read More
