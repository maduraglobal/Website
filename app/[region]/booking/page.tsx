...
export default function BookingPage() {
  ...
  return (
    <div className="min-h-screen bg-white py-16 text-[14px]">
          ...
          <div className="flex items-center justify-between mb-16 relative w-full lg:w-3/4 mx-auto">
            ...
            {[1, 2, 3].map((st) => (
              <div key={st} className="flex flex-col items-center gap-3">
                <div className={`w-12 h-12 rounded-full flex items-center justify-center  text-[15px] transition-all duration-500 border-2 ${step >= st ? 'bg-[#ee2229] text-white border-[#ee2229] shadow-lg shadow-red-500/20' : 'bg-white text-gray-300 border-gray-100'
                  }`}>
                ...
                <span className={`text-[11px]   tracking-[0.2em] ${step >= st ? 'text-[#191974]' : 'text-gray-300'}`}>
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-50 overflow-hidden min-h-[600px] flex flex-col">
          ...
          {step === 1 && (
            <div className="p-10 md:p-16 flex-1 flex flex-col">
              <h2 className="text-[32px]  text-[#191974] mb-8  tracking-tight text-center">Guest Information</h2>
              <form onSubmit={handleNextStep} className="flex flex-col gap-8 flex-1">

                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex flex-col gap-2.5">
                    <label className="text-[11px]  text-[#191974]  tracking-widest opacity-60">First Name</label>
                  ...
                  <div className="flex flex-col gap-2.5">
                    <label className="text-[11px]  text-[#191974]  tracking-widest opacity-60">Last Name</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="flex flex-col gap-2.5">
                    <label className="text-[11px]  text-[#191974]  tracking-widest opacity-60">Email Address</label>
                  ...
                  <div className="flex flex-col gap-2.5">
                    <label className="text-[11px]  text-[#191974]  tracking-widest opacity-60">Mobile Number</label>
                ...
                <div className="pt-10 mt-auto flex flex-col md:flex-row items-center justify-between border-t border-gray-50 gap-6">
                  <div className="flex items-center gap-6">
                    <div className="flex flex-col gap-1">
                      ...
                      <select name="pax" value={formData.pax} onChange={handleChange} className="bg-transparent  text-[#ee2229] outline-none cursor-pointer text-[16px]">
                    ...
                    <div className="flex flex-col gap-1 border-l border-gray-100 pl-6">
                      ...
                      <input required type="date" name="date" value={formData.date} onChange={handleChange} className="bg-transparent  text-[#ee2229] outline-none cursor-pointer text-[16px]" />
                    </div>
                  </div>
                  <button type="submit" className="w-full md:w-auto bg-[#ee2229] hover:bg-[#191974] text-white px-14 py-4 rounded-xl  text-[14px]  tracking-widest transition-all shadow-xl shadow-red-500/20 active:scale-95">
          ...
          {step === 2 && (
            <div className="p-10 md:p-16 flex-1 flex flex-col">
              <h2 className="text-[32px]  text-[#191974] mb-10  tracking-tight text-center">Review Confirmation</h2>
              ...
              <div className="bg-[#191974] rounded-2xl p-8 mb-10 flex flex-col md:flex-row gap-8 items-center justify-between text-white shadow-2xl">
                ...
                <div className="text-right border-l border-white/10 pl-8 hidden md:block">
                  ...
                  <span className="text-[32px]  text-[#ee2229] leading-none tracking-tighter">{formatRegionalPrice(totalBaseInrPrice, region)}</span>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
                <div className="space-y-4">
                  <h4 className="text-[12px]  text-[#191974]  tracking-widest border-b-2 border-[#191974]/5 pb-3">Primary Guest</h4>
                  <div className="space-y-1">
                    <p className=" text-[#191974] text-[18px] mb-1">{formData.firstName} {formData.lastName}</p>
                ...
                <div className="space-y-4">
                  <h4 className="text-[12px]  text-[#191974]  tracking-widest border-b-2 border-[#191974]/5 pb-3">Booking Details</h4>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-[10px] text-gray-400 font-bold  mb-1">Travelers</p>
                      <p className=" text-[#ee2229]">{formData.pax} Person(s)</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-gray-400 font-bold  mb-1">Date</p>
                      <p className=" text-[#ee2229]">{formData.date}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-auto flex flex-col md:flex-row justify-between items-center pt-10 border-t border-gray-50 gap-6">
                <button onClick={() => setStep(1)} className="text-[#191974]  text-[12px]  tracking-widest hover:text-[#ee2229] transition-colors ">
                  &larr; Modify Details
                </button>
                <button onClick={() => setStep(3)} className="w-full md:w-auto bg-[#ee2229] hover:bg-[#191974] text-white px-16 py-4 rounded-xl  text-[14px]  tracking-[0.2em] transition-all shadow-2xl active:scale-95">
                  Proceed to Payment
                </button>
              </div>
            </div>
          ...
          {step === 3 && (
            <div className="p-10 md:p-16 flex-1 flex flex-col items-center justify-center text-center">
              ...
              <button
                ...
                disabled={loading}
                className="w-full max-w-md bg-[#ee2229] hover:bg-[#191974] disabled:opacity-50 text-white py-5 rounded-2xl text-[14px]   tracking-[0.3em] transition-all shadow-2xl flex items-center justify-center mb-6 active:scale-95"
              >
                {loading ? (
