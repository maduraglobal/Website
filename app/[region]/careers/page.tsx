    ...
    <div className="min-h-screen bg-white font-inter">
      ...
      <section className="pt-40 pb-24 bg-[#191974] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <h1 className="text-[52px] md:text-[76px] font-black text-white uppercase tracking-tighter leading-none mb-6">
            ...
            <button className="bg-[#ee2229] hover:bg-white hover:text-[#191974] text-white px-10 py-4 rounded-xl font-bold uppercase tracking-widest transition-all">
              View Openings
            </button>
          </motion.div>
        </div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-[36px] font-black text-[#191974] uppercase tracking-tighter mb-4">Why Madura Travel?</h2>
            <p className="text-gray-400 font-bold uppercase tracking-widest text-[13px]">Build your future with the travel pioneers</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {perks.map((perk, i) => (
              <div key={i} className="p-10 rounded-[2.5rem] bg-gray-50 border border-gray-100 hover:border-[#ee2229] transition-all hover:bg-white hover:shadow-2xl hover:shadow-blue-900/5 group text-center">
                ...
                <h3 className="text-[20px] font-black text-[#191974] mb-3 uppercase">{perk.title}</h3>
      ...
      <section className="py-24 px-6 bg-gray-50 border-y border-gray-100">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-[36px] font-black text-[#191974] uppercase tracking-tighter mb-4">Current Open Positions</h2>
            ...
            {jobs.map((job, i) => (
              ...
              >
                <div>
                  ...
                  <div className="flex flex-wrap gap-4 text-[13px] text-gray-400 font-bold uppercase tracking-wider">
                ...
                <div className="flex items-center gap-4">
                  <span className="px-4 py-1.5 rounded-full bg-gray-50 text-gray-500 text-[11px] font-black uppercase tracking-widest">{job.type}</span>
          ...
          <div className="mt-12 text-center bg-[#191974] p-12 rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
            ...
            <h3 className="text-[28px] font-black uppercase mb-4">Don't see a fit?</h3>
            ...
            <a href="mailto:careers@maduratravel.com" className="inline-block bg-[#ee2229] text-white px-10 py-4 rounded-xl font-bold uppercase tracking-widest hover:bg-white hover:text-[#191974] transition-all">
              Apply Spontaneously
            </a>
          </div>
        </div>
