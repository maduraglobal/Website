...
export const ImagesSlider = ({
  ...
  return (
    ...
    >
      {/* Show children immediately so the UI doesn't feel slow */}
      <div className="relative z-60 h-full w-full flex items-center justify-center">
        {children}
      </div>
      ...
      {areImagesLoaded && (
        <AnimatePresence>
          <motion.img
            ...
            className="image h-full w-full absolute inset-0 object-cover object-center z-20"
          />
        </AnimatePresence>
      )}
    </div>
