  ...
  return (
    <section className="py-24 bg-[#F8F9FF] overflow-hidden relative min-h-[700px]">
      <div className="text-center mb-16 px-4 relative z-20">
        <h2 className="text-3xl font-black text-[#191974] mb-3 uppercase tracking-tight">Guest Testimonials</h2>
          ...
          >
            <div className="h-48 w-full relative overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-4">
                 <p className="text-white font-black text-sm uppercase tracking-wider">{testimonial.title}</p>
              </div>
            </div>
            ...
            <div className="p-6 flex flex-col flex-1">
              ...
              <div className="mt-auto pt-4 border-t border-gray-50">
                <p className="font-black text-[#191974] text-base">{testimonial.name}</p>
                <p className="text-[10px] text-[#ee2229] font-black uppercase tracking-widest mt-0.5">Verified Traveler</p>
              </div>
            </div>
          </DraggableCardBody>
        ))}
