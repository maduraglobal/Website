        ...
        <div key={item.day} className="border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm transition-all">
          ...
          >
            <div className="flex items-center gap-4">
              <span className="bg-[#191974] text-white text-[12px] font-bold px-3 py-1 rounded-full uppercase tracking-wide shrink-0">
                Day {item.day}
              </span>
          ...
          <div 
            className={`transition-all duration-300 ease-in-out overflow-hidden ${
              openDay === item.day ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'
            }`}
          >
