    ...
    <div className="flex flex-col gap-8 relative font-arial">
      ...
      <div className="bg-white rounded-3xl border border-gray-50 shadow-xl p-8 grid grid-cols-3 gap-6">
        <div className="text-center border-r border-gray-100">
          ...
          <p className="text-[9px] text-gray-300 uppercase font-black tracking-widest leading-tight mt-1">Global<br/>Guests</p>
        </div>
        <div className="text-center border-r border-gray-100">
          <p className="text-[20px] font-black text-[#191974] font-inter">30K+</p>
          <p className="text-[9px] text-gray-300 uppercase font-black tracking-widest leading-tight mt-1">Tour<br/>Success</p>
        </div>
        <div className="text-center">
          <p className="text-[20px] font-black text-[#191974] font-inter">30Y+</p>
          <p className="text-[9px] text-gray-300 uppercase font-black tracking-widest leading-tight mt-1">Heritage<br/>Expert</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-gray-50 shadow-2xl overflow-hidden">
        <div className="p-10">
          <div className="mb-8">
            <span className="text-[11px] text-gray-400 font-bold uppercase tracking-widest mb-2 block">Premium Package from</span>
            <div className="flex items-baseline gap-2">
              <span className="text-[32px] font-black text-[#191974] font-inter tracking-tighter">₹ {price.toLocaleString()}</span>
              <span className="text-[12px] text-gray-300 font-bold uppercase tracking-widest">per pax</span>
            </div>
          </div>
          
          <button className="w-full bg-[#ee2229] hover:bg-[#191974] text-white font-black py-5 rounded-2xl text-[14px] font-inter-tight uppercase tracking-widest transition-all mb-8 shadow-xl shadow-red-500/20 active:scale-95">
          ...
          <div className="grid grid-cols-4 gap-4">
             {[
              ...
              <button key={action.label} className="flex flex-col items-center gap-2 group">
                ...
                <span className="text-[9px] text-gray-400 font-black uppercase tracking-widest">{action.label}</span>
              </button>
            ))}
          </div>
        </div>
      ...
      <div className="bg-[#191974] rounded-3xl p-10 text-white shadow-2xl relative overflow-hidden">
        ...
        <h3 className="text-[20px] font-black font-inter mb-2 uppercase tracking-tight">Expert Callback</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-1.5">
            <label className="text-[9px] font-black text-white/40 uppercase tracking-[0.2em] ml-1">Full Identity</label>
            <input 
              type="text" 
          ...
          <div className="space-y-1.5">
            <label className="text-[9px] font-black text-white/40 uppercase tracking-[0.2em] ml-1">Contact Number</label>
          ...
          <button 
            type="submit"
            className="w-full bg-[#ee2229] hover:bg-white hover:text-[#191974] text-white font-black py-4.5 rounded-xl transition-all uppercase text-[14px] font-inter-tight tracking-widest shadow-xl shadow-black/20 mt-4 active:scale-95"
          >
            Request Assistance
          </button>
        </form>
