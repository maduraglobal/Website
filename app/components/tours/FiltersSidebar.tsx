  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
      ...
      <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-100">
        <h3 className="text-[18px] font-black text-[#191974] flex items-center gap-2 uppercase tracking-tight font-inter">
          <SlidersHorizontal className="w-5 h-5 text-[#ee2229]" /> Filters
        </h3>
        <button className="text-[13px] font-bold text-[#ee2229] hover:underline uppercase tracking-tighter font-inter-tight">Clear All</button>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <label className="text-[14px] font-black text-[#191974] block uppercase tracking-tight font-inter">Travel Dates</label>
        ...
        <div className="border-t border-gray-100 pt-6">
          ...
          >
            <span className="text-[14px] font-black text-[#191974] uppercase tracking-tight font-inter">Cities</span>
        ...
        <div className="border-t border-gray-100 pt-6">
          <button 
            ...
            className="flex items-center justify-between w-full text-left"
          >
            <span className="text-[14px] font-black text-[#191974] uppercase tracking-tight font-inter">Tour Duration</span>
          ...
          {isExpanded.duration && (
            <div className="mt-4 flex flex-wrap gap-2">
              {['1-3 Days', '4-6 Days', '7-10 Days', '11+ Days'].map((duration) => (
                <button key={duration} className="px-3 py-2 text-[12px] font-black border border-gray-200 text-gray-600 rounded-lg hover:border-[#191974] hover:bg-[#191974]/5 transition-all font-inter uppercase tracking-tighter">
                  {duration}
                </button>
              ))}
            </div>
        ...
        <div className="border-t border-gray-100 pt-6">
          <button 
            ...
            className="flex items-center justify-between w-full text-left"
          >
            <span className="text-[14px] font-black text-[#191974] uppercase tracking-tight font-inter">Specialty Tour</span>
