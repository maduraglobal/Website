    ...
    <div className="bg-[#f8f9fa] min-h-screen text-[#171717] font-sans">
      ...
      <div className="bg-[#191974] text-white py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-black mb-4 text-white uppercase tracking-tight font-poppins">
          ...
          {destinations.map((dest) => (
            <Link key={dest.id} href={`/destination/${dest.slug}`} className="group relative block overflow-hidden rounded-2xl aspect-[4/3] shadow-md hover:shadow-xl transition-all duration-300">
              ...
              <div className="absolute bottom-6 left-6 right-6">
                ...
                <span className="text-sm font-bold text-[#ee2229] bg-white/10 backdrop-blur-md px-3 py-1 rounded-full uppercase tracking-wider inline-block opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                  View Packages &rarr;
                </span>
              </div>
            </Link>
